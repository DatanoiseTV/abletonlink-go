...
#cgo linux LDFLAGS: -static -L${SRCDIR}/vendor/link/build -labl_link -lstdc++ -lpthread
#cgo windows LDFLAGS: -static -L${SRCDIR}/vendor/link/build -labl_link -lstdc++ -lpthread
#cgo darwin LDFLAGS: -L${SRCDIR}/vendor/link/build -labl_link -lstdc++ -lpthread
